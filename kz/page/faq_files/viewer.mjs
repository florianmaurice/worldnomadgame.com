...
(store.versions || (store.versions = [])).push({
  ...
  license: 'https://web.archive.org/web/20240909161418/https://github.com/zloirock/core-js/blob/v3.37.1/LICENSE',
  source: 'https://web.archive.org/web/20240909161418/https://github.com/zloirock/core-js'
});
...
const LOCALIZABLE_ATTRIBUTES = {
  ...
  "https://web.archive.org/web/20240909161418/http://www.mozilla.org/keymaster/gatekeeper/there.is.only.xul": {
...
class DownloadManager {
  ...
  download(data, url, filename, _options) {
    ...
    if (data) {
      ...
      if (!createValidAbsoluteUrl(url, "https://web.archive.org/web/20240909161418/http://example.com")) {
...
{
  const HOSTED_VIEWER_ORIGINS = ["null", "https://web.archive.org/web/20240909161418/http://mozilla.github.io", "https://web.archive.org/web/20240909161418/https://mozilla.github.io"];
...
/*
     FILE ARCHIVED ON 16:14:18 Sep 09, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 08:38:45 Oct 03, 2025.
...
playback timings (ms):
  ...
  esindex: 0.016
  cdx.remote: 39.56
  LoadShardBlock: 163.669 (3)
  PetaboxLoader3.datanode: 183.035 (4)
  load_resource: 99.051
  PetaboxLoader3.resolve: 51.268
*/